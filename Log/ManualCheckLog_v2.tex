...
\begin{center}
    			\begin{tabular}{ |c|c|r|c|c|} \hline%{ |p{5mm} |p{15mm}|p{26mm}|p{24mm}|p{24mm}|p{20mm}|p{40mm}|} \hline
				 &Area &Event\quad &check&Comment\hspace{12cm} \\
				\hline \hline
				 #1
			\end{tabular}
 	\end{center}
...
\setlength{\FreeSpaceOverhead}{8cm}% itembox自体の罫線・タイトル分の余白(実測して調整済み)
\newcommand{\FreeSpace}{%
	\vspace{2cm}%
